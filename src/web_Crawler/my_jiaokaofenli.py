...
填空题的答案的键(key): "referenceAnswer"。

应用题的话，虽然答案的key也是: "answer"，但是也有图片什么的，所以后续应该还要手动整理。
...
target_url = "https://wisdom2.prod.shangyuninfo.com/prod-api/roomUserQuestion/info/question?cardOrder=95"
